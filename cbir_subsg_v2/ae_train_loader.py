from cbir_subsg_v2.test import validation
from utils import utils
from utils import data
from cbir_subsg_v2 import models
from cbir_subsg_v2.conf import parse_encoder
...
def batch_nx_graphs_rpe(graphs, anchors=None):
    ...
    for g in graphs:
        ...
        for e in list(g.edges):
                ...
                dotproduct = g.edges[e[0], e[1]]['dotproduct'] # 10 
                newG.edges[e]["edge_feature"] = torch.tensor(np.concatenate((txtemb, dotproduct), axis=None))
...
def train_loop(args):
    ...
    data_folder = 'data/dataset02/training'
