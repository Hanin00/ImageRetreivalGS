...
from cbir_cbir_subsg_v2subsg.conf import parse_encoder
...
def main():
    ...
    df.to_parquet("subgraphFeature_GAT_edgeattrall_15-.parquet", engine="pyarrow", compression="gzip")
    # df.to_parquet('subgraphFeature_cbir.parquet', engine='fastparquet', compression='snappy')
    df.to_csv("subgraphFeature_GAT_edgeattrall_15-.csv")  
