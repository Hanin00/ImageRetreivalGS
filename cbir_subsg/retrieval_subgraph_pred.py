...
from utils import utils_pred as utils
from cbir_subsg import models
from cbir_subsg.conf_pred import parse_encoder
...
def load_dataset_temp(args,F0Dict):
    ...
    with open("result/vid08_1215_sceneg_4005_subg_12926_pred.pkl", "wb") as fw:
...
def feature_extract(args):
    ...
    with open("result/1217/vid08_1217_from_db_pred.pkl", "wb") as fw:
    # with open("result/result_graphs_pred_video02.pkl", "wb") as fw:
