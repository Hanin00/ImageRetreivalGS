...
from surel_utils.utils import get_pos_neg_edges, np_sampling

#DEDataset -> gen_dataset -> 
...
class DEDataset():
    def __init__(self, dataset, mask_ratio=0.05, use_weight=False, use_coalesce=False, use_degree=False,
        ...
        # print("len['train']['source_node']") 
        # print(len(self.data.get_edge_split()['train']['source_node'])) #30387995
        
        # print(len(self.data[0]['x'])) #2927963 : node 개수        
        # print(len(self.data[0]['x'][0])) #128 : feature dimension
        
        # print("split_edge")
        # print(self.data.get_edge_split())
        # print("train")
        # print(self.data.get_edge_split()['train'])
        # print("['train']['source_node']")
        # print(self.data.get_edge_split()['train']['source_node'])
        # print("['train']['target_node']")
        # print(self.data.get_edge_split()['valid']['target_node'])
        # print("['valid']['target_node_neg']")
        # print(self.data.get_edge_split()['valid']['target_node_neg'])
        # print("test")
        # print(self.data.get_edge_split()['test'])
                # sys.exit()
        ...
        if 'x' in self.graph:
            ...
            # print("data[0]: ", self.data[0]) #128 차원의 feature 값을 갖는 노드  2927963, edge 30387995 개의 그래프
            # data[0]:  Data(num_nodes=2927963, edge_index=[2, 30387995], x=[2927963, 128])
            print(' feature!!!!')
        else:
