    ...
    for idx, walks in enumerate(walk_set):
      ...
      for walk in tempWalks: 
        ...
        for idx2 in walk:         
          #idx2: node id
          #idx: walkset idx          
          featL.extend(*node_freq[idx][np.where(node_id[idx] == idx2)])
          subG.nodes[idx2]['rpe'] = (node_freq[idx][np.where(node_id[idx] == idx2)])
...
def main():
  ...
  # with open('common/rp_data/rpe_v3_x1000_meta.pkl', 'wb') as f:
  with open('common/rp_data/rpe_v3_imgId100_meta.pkl', 'wb') as f:
   pickle.dump(metaData, f)

  print("len(totalSubG): ",len(totalSubG))
  # with open('rpe_v3_x1000_SubG.pkl', 'wb') as f:
  with open('common/rp_data/rpe_v3_imgId100_SubG.pkl', 'wb') as f:
    pickle.dump(totalSubG, f)

  print("len(totalSubGFeat): ",len(totalSubGFeat))
  # with open('rpe_v3_x1000_SubGFeat.pkl', 'wb') as f:
  with open('common/rp_data/rpe_v3_imgId100_SubGFeat.pkl', 'wb') as f:
  ...
  # with open('common/rp_data/rpe_v3_x1000_SubGFeat.pkl', 'rb') as f:
  with open('common/rp_data/rpe_v3_imgId100_SubGFeat.pkl', 'rb') as f:
    list2 = pickle.load(f)
